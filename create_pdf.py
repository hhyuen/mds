...
ORDERED_IMAGES = [
    ...
    ("cpc.png", "2. Market Sentiment — Measured by dividing total traded put option volume by call option volume; high values indicate elevated bearish hedging or panic, while low values signal excessive bullish complacency"),
