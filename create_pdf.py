...
ORDERED_IMAGES = [
    ...
    ("cpc.png", "2. Market Sentiment — $CPC (Total Put Call Ratio) Measured by dividing total traded put option volume by call option volume; high values indicate elevated bearish hedging or panic, while low values signal excessive bullish complacency"),
    ("cot.png", "2. Market Sentiment — COT Index tracks the Commercial's net positions in the futures market over the last 26 weeks"),
